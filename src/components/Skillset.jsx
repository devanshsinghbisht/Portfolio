  ...
  return (
    <>
      <div
        name="skillset"
        id="Skillset"
        className="container max-w-6xl py-[20px] my-5 lg:p-16 md:py-20"
      >
        <motion.h1
          ...
          viewport={{ once: true }}
          id="heading"
          className="md:text-[35px] text-[24p x] text-black  dark:text-slate-300 font-Ramabhadra text-center"
        >
          My Skillset
        </motion.h1>
        <motion.div
          ...
          {Skillsets.map((item) => (
            ...
            >
              <svg
                ...
                className="w-9 h-9 pointer-events-none z-5 fill-black dark:fill-slate-200 bg-transparent"
                width="24"
                height="24"
              ...
              <p className="hidden md:block z-5 flex-initial pl-5 lg:text-[18px] pointer-events-none md:text-[16px] bg-transparent font-Ramabhadra text-black dark:text-slate-200">
                {item.name}
              </p>
            </motion.div>
          ))}
