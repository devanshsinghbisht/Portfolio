                        ...
                        {Info.map((item) => (           
                            <div key={item.key} className="flex items-center flex-row lg:m-4">
                                ...
                                <motion.div variants={fadeIn('up' , 80)} className="flex flex-col p-2 m-2  self-center">
                                    <h1 className='text-[32px] text-black  dark:text-slate-300 font-Ramabhadra'>{item.text1}</h1>                       
                                    <span className="text-md text-black dark:text-slate-300 font-Ramabhadra">{item.text2}</span>
                                </motion.div>
                            </div>
                        ))} 
                    </motion.div>
