                ...
                <div className="flex flex-col gap-5 h-full md:basis-2/4  basis-2/3 items-center">
                    <div className="flex flex-row py-5 md:gap-20 gap-5">
                        <motion.div variants={fadeIn('up' , 10  )} transition = {{type : 'spring' , duration : 0.5 , bounce : 0.5}}>                             
                            <Link to='skillset' className="text-slate-300 md:text-[18px] cursor-pointer hover:text-white first-letter:text-[16px] font-Ramabhadra">Skillset</Link>
                        </motion.div>
                        <motion.div variants={fadeIn('up' , 10  )} transition = {{type : 'spring' , duration : 0.5 , bounce : 0.5}}>                          
                            <Link  to='projects' className="text-slate-300 md:text-[18px] cursor-pointer hover:text-white text-[16px] font-Ramabhadra">Projects</Link>
                        </motion.div>
                        <motion.div variants={fadeIn('up' , 10  )} transition = {{type : 'spring' , duration : 0.5 , bounce : 0.5}}>                          
                            <Link to='contact' className="text-slate-300 md:text-[18px] cursor-pointer hover:text-white first-letter:text-[16px] font-Ramabhadra">Contact me</Link>
                        </motion.div>
                    </div>  
