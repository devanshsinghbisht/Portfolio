  ...
  return (
    <>
      <div
        name="projects"
        id="Project"
        className="container max-w-6xl md:px-5 py-[20] my-5 lg:p-5 lg:py-20 md:py-20"
      >
        <motion.h1
          ...
          viewport={{ once: true }}
          className="md:text-[35px]  text-[24px] justify-center text-center text-black dark:text-slate-300 font-Ramabhadra"
        >
          My Projects
        </motion.h1>
        <motion.p
